...
(function () {
  ...
  var ROLE_PERMS = {
    super_admin: ['dashboard','users','matches','transactions','units','analytics','settings'],
    admin:       ['dashboard','users','matches','transactions','units','analytics'],
    moderator:   ['dashboard','matches']
  };
